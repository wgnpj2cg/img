...
<div class="rating_more" style="display:none"></div>`); // 修复部分情况$("div.rating_betterthan")不存在情况
            ...
            if (_version === "完整版") {
                ...
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: "LemonHD", link: 'https://lemonhd.org/torrents.php?incldead=1&search_area=0&notnewword=1&search=' + unititle, },
                        { name: "MTeam", link: 'https://kp.m-team.cc/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + neizhan, },
            ...
            if (!(is_mandarine) || (is_mandarine && is_otherlan)) {
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: '字幕库', link: 'http://www.zimuku.org/search?q=' + dbzw, selector: 'div.box.clearfix div.item.prel.clearfix' },
                    ]
                });
            }
            if (!(is_mandarine) || (is_mandarine && is_otherlan)) {
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: 'Z-Library', link: 'https://2lib.org/s/?e=1&q=' + isbn, selector: '#searchResultBox a.tdn' },
